# Generated by Django 4.2.3 on 2023-08-01 18:17
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('loan_name', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='finance.transactioncategory')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('budgets', models.ManyToManyField(blank=True, to='finance.budget')),
                ('loans', models.ManyToManyField(blank=True, to='finance.loan')),
